...
1.​ User input: Enter a place they want to visit
2.​ Parent Agent: Tourism AI Agent (orchestrates the system)
3.​ Child Agent 1: Weather Agent (checks current/forecast weather)
4.​ Child Agent 2: Places Agent (suggests up to 5 tourist attractions)
5.​ Error Handling: For non-existent places, let AI respond that It doesn’t know this
place exist
Open-Source API Recommendations
You can figure out your own APIs, requirement is Child Agents or (Tools) should use some
API source instead of using the AI’s own knowledge
Weather APIs
